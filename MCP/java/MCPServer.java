...
// Import Delete_Username_Provider_Id_KeyMCPTool - included in same package
// Import Get_UsernameMCPTool - included in same package
// Import Post_EncryptMCPTool - included in same package
// Import Delete_KeyMCPTool - included in same package
// Import Get_UpnMCPTool - included in same package
// Import Get_Ticket_IdMCPTool - included in same package
// Import Delete_Ticket_IdMCPTool - included in same package
// Import Post_AuthorizeMCPTool - included in same package
// Import Post_Service_ValidateMCPTool - included in same package
// Import GetMCPTool - included in same package
// Import Post_P3_Service_ValidateMCPTool - included in same package
// Import Delete_ExpireMCPTool - included in same package
// Import Post_DecryptMCPTool - included in same package
// Import GetMCPTool - included in same package
// Import PostMCPTool - included in same package
// Import Get_Cache_UsernameMCPTool - included in same package
// Import Delete_Cache_UsernameMCPTool - included in same package
// Import Get_Well_Known_Acme_Challenge_TokenMCPTool - included in same package
// Import Post_V1_ServicesMCPTool - included in same package
// Import Delete_CleanMCPTool - included in same package
// Import Get_RepositoriesMCPTool - included in same package
// Import Get_TermMCPTool - included in same package
// Import Post_AuthzenMCPTool - included in same package
// Import Post_Logout_PostMCPTool - included in same package
// Import Post_ValidateMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Delete_Username_Provider_Id_KeyMCPTool.createDelete_Username_Provider_Id_KeyTool(config),
            Get_UsernameMCPTool.createGet_UsernameTool(config),
            Post_EncryptMCPTool.createPost_EncryptTool(config),
            Delete_KeyMCPTool.createDelete_KeyTool(config),
            Get_UpnMCPTool.createGet_UpnTool(config),
            Get_Ticket_IdMCPTool.createGet_Ticket_IdTool(config),
            Delete_Ticket_IdMCPTool.createDelete_Ticket_IdTool(config),
            Post_AuthorizeMCPTool.createPost_AuthorizeTool(config),
            Post_Service_ValidateMCPTool.createPost_Service_ValidateTool(config),
            GetMCPTool.createGetTool(config),
            Post_P3_Service_ValidateMCPTool.createPost_P3_Service_ValidateTool(config),
            Delete_ExpireMCPTool.createDelete_ExpireTool(config),
            Post_DecryptMCPTool.createPost_DecryptTool(config),
            GetMCPTool.createGetTool(config),
            PostMCPTool.createPostTool(config),
            Get_Cache_UsernameMCPTool.createGet_Cache_UsernameTool(config),
            Delete_Cache_UsernameMCPTool.createDelete_Cache_UsernameTool(config),
            Get_Well_Known_Acme_Challenge_TokenMCPTool.createGet_Well_Known_Acme_Challenge_TokenTool(config),
            Post_V1_ServicesMCPTool.createPost_V1_ServicesTool(config),
            Delete_CleanMCPTool.createDelete_CleanTool(config),
            Get_RepositoriesMCPTool.createGet_RepositoriesTool(config),
            Get_TermMCPTool.createGet_TermTool(config),
            Post_AuthzenMCPTool.createPost_AuthzenTool(config),
            Post_Logout_PostMCPTool.createPost_Logout_PostTool(config),
            Post_ValidateMCPTool.createPost_ValidateTool(config)
            );
